...
```yaml
- name: IMAGINE'S BLOG # 昵称
  desc: WEB前端搬砖日志；积跬步以至千里，积小流以成江海。 # 介绍
  avatar: https://s1.328888.xyz/2022/09/06/1vqlP.jpg # 头像
  link: https://lp-imagine.github.io/vuepressblog/  # 链接
```
