...
const DOMAIN_NAME = 'github.com/lp-Imagine' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "IMAGINE'S BLOG",
      description: 'web前端技术博客,专注web前端学习与总结。JavaScript,js,ES6,TypeScript,vue,React,css3,html5,Node,git,github等技术文章。',
    }
  },
  base: '/vuepressblog/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
      ...
      { text: '首页', link: '/' },
      {
        ...
        items: [
          // 说明：以下所有link的值只是在相应md文件头部定义的永久链接（不是什么特殊编码）。另外，注意结尾是有斜杠的
          {
            text: '原生JS',
            items: [
              { text: 'JavaScript', link: '/pages/048e07/' },
            ],
          },
          {
            text: '前端框架扩展',
    ...
    logo: '/img/favicon-32x32.png', // 导航栏logo
    repo: 'lp-Imagine', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'peng', // 必需
      link: 'https://github.com/lp-Imagine', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://i0.imgs.ovh/2024/03/24/guGRv.jpeg',
      name: 'peng',
    ...
    footer: {
      ...
      copyrightInfo:
        `peng | <a href="https://lp-imagine.github.io/vuepressblog/" target="_blank">IMAGINE</a>
        <br/>image | <a href="https://imgloc.com/" target = "_blank" > imgloc.com </a>`,
